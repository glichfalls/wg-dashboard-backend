...
use App\Entity\WasteDisposalDate;
...
#[AsCommand('app:import:waste-disposal-calendar')]
class WasteDisposableCalendarImportCommand extends Command
{
    ...
    public function __construct(private readonly EntityManagerInterface $manager, HttpClientInterface $client)
    {
        parent::__construct();
